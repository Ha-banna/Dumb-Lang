...
int main(int argc, string argv[])
{
	...
	if (strcmp(argv[1], "docs") == 0)
	{
		...
		printf("-: subtract 1\n");
		printf("!: print\n");
		printf("c: print as ascii character however the ascii table will start at 32 instead of zero, which in this language 0 = 32 on the ascii table, EX: 1 = '!'(dumb lang) 33 = '!'(ascii table)\n");
		printf("n: newline\n");
